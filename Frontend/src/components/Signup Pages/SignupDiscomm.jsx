...
const SignupDiscomm = () => {
 ...
 const handleSubmit = async (e) => {
  ...
  try {
    const res = await axios.post("http://localhost:8080/api/auth/signup/discomm", formData);
 ...
 return (<>
    ...
    <div className="max-w-lg mx-auto mt-20 p-8 bg-white rounded-lg shadow-lg">
      <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Discomm Signup</h2>
